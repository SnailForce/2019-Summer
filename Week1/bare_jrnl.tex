...
\title{2019 Summer First Homework}
%
%
...
\begin{IEEEkeywords}
linear regression, polynomial regression, PCA
\end{IEEEkeywords}
...
\end{equation}
\begin{equation}
y = 2.5x^2 - 23.58x + 70.67
\end{equation}
\begin{equation}
y = -0.78x^3 + 17.08x^2 - 112.65x + 248.08
\end{equation}
\begin{equation}
	\begin{aligned}
	y = {}& -0.48x^5 + 14.47x^4 - 169.94x^3 + {} \\
	& 984.96x^2 - 2818.45x + 3199.97
	\end{aligned}
\end{equation}

\begin{equation}
\begin{aligned}
y = {}&-0.0042x^{10} + 0.23^9 -5.53x^8 + 76.18x^7 - {} \\
& 658.89x^6 + 3673.26x^5 - 12909.45x^4 + {} \\
& 25789.73x^3 - 1823396x^2 - 24984.63x + 41672.47{}
\end{aligned}
\end{equation}
\begin{figure}[h]
	\centering
	\includegraphics[width = .35\textheight]{1.eps}
	\caption{House price fitting model map}
\end{figure}
...
\subsubsection{$R^2$}
The coefficient of determination ($R^2$) is used in statistics to measure the proportion of the variation of the dependent variable that can be interpreted by the independent variable, so as to judge the explanatory power of the statistical model.
\subsection{Conclusion}
\begin{table}[h]
	\centering
	\caption{Comparison of evaluation indicators}
	\begin{tabular}{ccc}
		\hline
		Module& MSE& $R^2$\\
		\hline
...
\begin{figure}[h]
	\centering
	\includegraphics[width = .35\textheight]{2.eps}
	\caption{Data points after dimensionality reduction}
\end{figure}

The analysis of the 3D data after PCA only contains about 40\% of the original data, indicating that the PCA dimension reduction process has lost too much information. Therefore, in order to retain 99\% of useful information, the PCA automatically selects which dimensions of information to retain, and finally finds that when retaining 41-dimensional information, more useful information can be retained, and the dimension of the data amount is reduced to some extent. It is helpful to speed up the training process and prevent the occurrence of over-fitting.
...
\begin{thebibliography}{4}
	\bibitem{citekey}https://www.researchgate.net/publication/243771074
	\bibitem{citekey}https://blog.csdn.net/u013096666/article/details/72627001
	\bibitem{citekey}https://www.cnblogs.com/yifdu25/p/8330652.html
	\bibitem{citekey}https://liam.page/2014/09/08/latex-introduction/
\end{thebibliography}
